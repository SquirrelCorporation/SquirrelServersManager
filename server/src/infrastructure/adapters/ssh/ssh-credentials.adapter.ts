...
// Export instance as singleton for backward compatibility
export const sshCredentialsAdapter = new SSHCredentialsAdapter();
export default sshCredentialsAdapter;
