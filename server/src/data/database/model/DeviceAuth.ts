...
import { RemoteConnectionMethod } from 'ssm-shared-lib/distribution/enums/proxmox';
...
export default interface DeviceAuth {
  ...
  proxmoxAuth?: {
    remoteMethod?: SsmProxmox.RemoteConnectionMethod;
    method?: SsmProxmox.ConnectionMethod;
    port?: number;
    userPwd?: {
      userName?: string;
      password?: string;
