...
describe('DashboardService', () => {
  ...
  describe('getDevicesAvailability', () => {
    it('should return device availability data', async () => {
      ...
      mockDeviceDownTimeService.getDevicesAvailabilitySumUpCurrentMonthLastMonth.mockResolvedValue(mockAvailability);
      
      // Test
      const result = await dashboardService.getDevicesAvailability();
      
      // Verify
      expect(mockDeviceDownTimeService.getDevicesAvailabilitySumUpCurrentMonthLastMonth).toHaveBeenCalled();
  ...
  describe('getSingleAveragedStatsByDevicesAndType', () => {
    it('should return and sort averaged stats for specified devices', async () => {
      ...
      // Test
      const result = await dashboardService.getSingleAveragedStatsByDevicesAndType(devices, from, to, type);
      
      // Verify
      expect(mockDeviceStatsService.getSingleAveragedStatsByDevicesAndType).toHaveBeenCalledWith(
        devices, from, to, type
      );
