...
export class PreCheckDeviceConnectionDto {
  @ApiPropertyOptional({
    description: 'Master node URL (if applicable)',
    example: 'https://master.node.url',
  })
  @IsOptional()
  @IsString()
  ...
  @ApiPropertyOptional({
    description: 'SSH connection method',
    enum: SsmAnsible.SSHConnection,
    example: SsmAnsible.SSHConnection.PARAMIKO,
  })
  @IsOptional()
