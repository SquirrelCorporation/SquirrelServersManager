 ...
 * Please use the new ContainersController in presentation/controllers/containers.controller.ts
 */

import { parse } from 'url';
import { Body, Controller, Delete, Get, Inject, Logger, Param, Post, Put, Req, Res, UseGuards } from '@nestjs/common';
...
export class ContainersController {
   ...
   * @deprecated Use the new ContainersController
   */
  @Get()
  async getContainers(@Req() req: Request, @Res() res: Response): Promise<void> {
    this.logger.warn('Endpoint GET /containers is deprecated. Please use the new controller.');
    
    try {
      // Try to use the new container service
      const containers = await this.newContainerService.getAllContainers();
  ...
  async postCustomNameOfContainer(
    ...
    this.logger.warn('Endpoint POST /containers/:id/name is deprecated. Please use the new controller.');
  ...
  async refreshAll(@Res() res: Response): Promise<void> {
    this.logger.warn('Endpoint POST /containers/refresh is deprecated. Please use the new controller.');
  ...
  async postDockerContainerAction(
    ...
    this.logger.warn('Endpoint POST /containers/:id/docker/action/:action is deprecated. Please use the new controller.');
  ...
  async postProxmoxContainerAction(
    ...
    this.logger.warn('Endpoint POST /containers/:uuid/proxmox/action/:action is deprecated. Please use the new controller.');
