...
import { DOCKER_WATCHER_COMPONENT_FACTORY } from './domain/components/docker-watcher.interface';
...
@Module({
  ...
  providers: [
    ...
    {
      provide: WatcherComponentFactory,
      useClass: WatcherComponentFactory,
    },
    {
      provide: DOCKER_WATCHER_COMPONENT_FACTORY,
      useClass: DockerWatcherComponentFactory,
    },
    // Registry components
