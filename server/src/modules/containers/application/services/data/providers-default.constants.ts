import { REGISTRIES } from '@modules/containers/application/services/components/core/constants';
import { RegistryAuthConfig } from '@modules/containers/types';

export const DEFAULT_REGISTRIES_CONFIGURATION: RegistryAuthConfig[] = [
  {
