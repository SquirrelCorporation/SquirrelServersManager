import { ContainerCustomStack, IContainerCustomStackRepositoryEntity } from '../entities/container-custom-stack.entity';
...
export interface IContainerCustomStackRepository {
  ...
  listAllByRepository(repository: IContainerCustomStackRepositoryEntity): Promise<ContainerCustomStack[]>;
}