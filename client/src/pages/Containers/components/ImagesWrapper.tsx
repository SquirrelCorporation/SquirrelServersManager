...
import { ImagesPage } from '@features/container-images';
import LegacyImages from './Images'; // The existing Images component

/**
 * Wrapper component that switches between legacy and FSD Images implementation
 * based on feature flag configuration
 */
export const ImagesWrapper: React.FC = () => {
